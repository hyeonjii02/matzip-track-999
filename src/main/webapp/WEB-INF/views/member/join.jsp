        ...
        <section class="signUp">
           ...
           <form action="./join" method="POST" name="frmUser" class="form" onsubmit="return valid()">
                ...
                <div class="form_input-block" id="phone-Box">
                    <input type="text" name="phone" id="userPhone1" placeholder="전화번호" maxlength="3" value="010">
                    <input type="text" name="phone" id="userPhone2" placeholder="전화번호" maxlength="4">
                    <input type="text" name="phone" id="userPhone3" placeholder="전화번호" maxlength="4">
                ...
                <div class="btn">
                    <button class="button2" onclick="valid()" type="submit">가입</button>
